...
import (
	...
	"github.com/TeaOSLab/firewall-server/internal/events"
	"github.com/TeaOSLab/firewall-server/internal/firewalls/nftables"
	"github.com/TeaOSLab/firewall-server/internal/goman"
	"github.com/TeaOSLab/firewall-server/internal/remotelogs"
	"github.com/TeaOSLab/firewall-server/internal/utils"
...
func (this *NFTablesFirewall) DropSourceIP(ip string, timeoutSeconds int, async bool) error {
	...
	var ipLong = utils.IPString2Long(ip)
	if strings.Contains(ip, ":") { // ipv6
